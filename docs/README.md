...
| 查看调查与修改前确认协议 | [`PLAN-FIRST-PROTOCOL.md`](PLAN-FIRST-PROTOCOL.md) | v0.2.x 当前协议 |
...
| 主题 | 文档 | 结果 |
|---|---|---|
| Supervisor Agent 总计划 | [`VEGA-SUPERVISOR-AGENT-V1-PLAN.md`](VEGA-SUPERVISOR-AGENT-V1-PLAN.md) | 历史实施记录，V1 已随 v0.2.0 发布 |
| GitHub Pages 展示设计 | [`GITHUB-PAGES-SHOWCASE-V1-PLAN.md`](GITHUB-PAGES-SHOWCASE-V1-PLAN.md) | 历史设计记录；当前页面固定回放 v0.2.0 证据 |
| Supervisor Agent 交接时间线 | [`SUPERVISOR-AGENT-V1-HANDOFF.md`](SUPERVISOR-AGENT-V1-HANDOFF.md) | 历史交接记录，不作为当前执行入口 |
| Gate 2B | [`SUPERVISOR-AGENT-GATE-2B-PLAN.md`](SUPERVISOR-AGENT-GATE-2B-PLAN.md) | 历史 Gate 记录，`gate-exit-pass` |
