...
def load_ma2b_execution_binding(
    *,
    ...
    _validate_pricing_manifest_ref(repo, binding.pricing_manifest_ref)
    return binding
...
def _validate_pricing_manifest_ref(repo: Path, reference: ArtifactReference) -> None:
    ...
    try:
        ...
        raise MA2BExecutionBindingError("pricing_manifest_invalid_json") from exc
